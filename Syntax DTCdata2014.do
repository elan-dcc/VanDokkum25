* Preparation of datasets in order to create seperate datasets with all CLRTI cases and a separate dataset with comorbidities of everyone in The Hague
...
*merging datasets first with postal codes to only include people living in The Hague in 2014
use "G:\GezondheidWelzijn\MSZSUBTRAJECTENTAB\geconverteerde data\MSZSubtrajecten2014TABV3.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZ2014.dta", replace
...
use "G:\GezondheidWelzijn\MSZGELEVERDZORGPROFIELTAB\geconverteerde data\MSZGeleverdZorgprofiel2014TABV3.dta", clear
...
sort MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZZorgactiviteiten2014.dta", replace

*merge MSZSubtrajecten met MSZzorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZ2014.dta"
merge m:m MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZZorgactiviteiten2014.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZMERGED2014.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2014\geconverteerde data\MEDICIJN2014TABV1.dta", clear
...
recode ATC4_category (16/17=1) (179/182=2) (143=3) (136 139=4) (110=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MEDICIJNEN2014.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MSZMERGED2014.dta", clear
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\Comorbidities_DTC_2014_temp.dta", replace
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\Comorbidities_DTC_2014_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ `comorb'_DTC_2014_temp.dta", replace
}

use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Neoplastic_Disease_DTC_2014_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Liver_Disease_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Congestive_HF_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Cerebrovascular_Disease_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Renal_Disease_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Pulmonary_Disease_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Dementia_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Neurologic_Disease_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Diabetes_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ HIV_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Immunocompromised_DTC_2014_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ Cardiovascular_Disease_other_DTC_2014_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ComorbiditiesDBC2014.dta", replace

*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\MEDICIJNEN2014.dta", clear
generate Diabetes = .
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ComorbiditiesMED2014.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ComorbiditiesDBC2014.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ComorbiditiesMED2014.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\ComorbiditiesMerged2014.dta", replace

* Preparation for Datasets for CLRTI 
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI&Asthma_COPD2014.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\SEH2014.dta", replace
...
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\Beeldvorming2014.dta", replace

*Gecombineerde dataset LRTI&Asthma_COPD + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI&Asthma_COPD2014.dta", clear
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons MSZSTRZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\SEH2014.dta"
keep if _merge == 3
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_SEH2014.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_SEH2014.dta", clear
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons MSZSTRZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\Beeldvorming2014.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_COPD_SEH_Beeld2014.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_SEH_Beeld2014.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\HospitalAdmissions2014_all.dta", replace


*Merging datasets for LRTI, Hospital Admissions and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_SEH_Beeld2014.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\InclusionDeath2014.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\LRTI_SEH_Beeld2014.dta", clear
sort rinpersoon rinpersoons
merge 1:m rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\HospitalAdmissions2014_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons 
...
foreach numrti of numlist 1/2 {
	foreach numopn of numlist 1/47 {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\InclusionsHospital2014.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2014\CLRTI2014.dta", replace

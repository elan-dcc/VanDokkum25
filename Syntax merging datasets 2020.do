...
use "G:\Bevolking\GBAPERSOONTAB\2020\geconverteerde data\GBAPERSOON2020TABV3.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\PERSOONTAB2020.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\POSTCODES2020.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ADRESSEN2020.dta", replace
...
merge m:1 rinobjectnummer soortobjectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\POSTCODES2020.dta"
...
drop if GBADATUMEINDEADRESHOUDING < date("20191231", "YMD") 
drop if GBADATUMAANVANGADRESHOUDING > date("20210101", "YMD")
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHABITANTS_THEHAGUE_2020.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\PERSOONTAB2020.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHABITANTS_THEHAGUE_2020.dta"

keep if _merge == 3 
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V1.dta", replace
...
* import spss using "G:\Bevolking\SESWOA\SESWOA2020V2.sav", clear
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SESWOA2020V1.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SESWOA2020.dta", replace
* SESWOA per household
*preparation of Inhatab
*use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2020V2.dta" to match rinpersoon to household
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\INHA2020TABV2.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHATAB2020.dta", replace
*income per household*
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2020V2.dta"
...
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHATAB2020.dta"

sort rinpersoon rinpersoons
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHATAB2020Linked.dta", replace
*household income per person*
*preparation of Vehtab
use "G:\InkomenBestedingen\VEHTAB\geconverteerde data\VEH2020TABv3.DTA"
rename RINPERSOONSHKW rinpersoonshkw
rename RINPERSOONHKW rinpersoonhkw
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VEHTAB2020.dta", replace
*en 2019 om jaar ervoor mee te nemen
...
use "G:\InkomenBestedingen\VEHTAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2020V2.dta"
sort rinpersoonhkw rinpersoonshkw
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VEHTAB2020.dta"
rename VEHP100WELVAART VEHP100WELVAART2020 
rename VEHP100HVERM VEHP100HVERM2020 
rename VEHW1000VERH VEHW1000VERH2020
drop _merge
...
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VEHTAB2020Linked.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHATAB2020Linked.dta"
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VEHTAB2020Linked.dta"
sort rinpersoonhkw rinpersoonshkw
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VermogenInkomen2020.dta", replace 
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\VermogenInkomen2020.dta", clear
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SESWOA2020.dta"

sort rinpersoon rinpersoons

drop _merge 
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SESMERGED2020.dta", replace
*household income and wealth per person, SESWOA per person *
*merging the main merged file with SESWOA
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V1.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SESMERGED2020.dta"
keep if _merge == 3 | _merge == 1
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V2.dta", replace
...
use "G:\Bevolking\GBAOVERLIJDENTAB\2020\geconverteerde data\GBAOVERLIJDEN2020TABV1.DTA", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\OverlijdensDatum.dta", replace
*date of death per person*
*sorting of cause of death dataset
*import spss using "G:\GezondheidWelzijn\DOODOORZTAB\2020\DOODOORZ2020TABV2.sav", clear
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\DOODOORZ2020TABV2.dta", clear
rename RINPERSOON rinpersoon
rename RINPERSOONS rinpersoons
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Doodsoorzaak2020.dta", replace
*cause of death per person*
*HB: hier kunnen alle 'externe doodsoorzaak' variabelen uit 
*linking cause of death to death date 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\OverlijdensDatum.dta"
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Doodsoorzaak2020.dta"

gen overlijdensdatum = date(GBADatumOverlijden, "YMD")
format overlijdensdatum %td
gen overleden_2020 = 1 if overlijdensdatum <= date("20201231", "YMD") & overlijdensdatum >= date("20200101", "YMD")
replace overleden_2020 = 0 if overleden_2020 == .
tab _merge overleden_2020, m col

rename _merge merge_mortality
drop NNDLocationCode PLOVL STATJAAR overleden_2020 GBADatumOverlijden
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SterfteMERGED.dta", replace
*merging main merged file with mortality information
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V2.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SterfteMERGED.dta"
sort rinpersoon rinpersoons
drop if _merge == 2
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V3.dta", replace
...
use "G:\Bevolking\GBAHUISHOUDENSBUS\opgesplitste jaarbestanden\GBAHUISHOUDENSBUS2020.dta", clear
sort rinpersoon rinpersoons
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHABITANTS_THEHAGUE_2020.dta"
keep if _merge == 3
drop _merge
sort rinpersoon rinpersoons
gen date_start = date(datumaanvanghh, "YMD")
gen date_end = date(datumeindehh, "YMD")
...
generate Household2020 = 1 if typhh == 1 & plhh == 2 & aantalpershh == 1 
replace Household2020 = 2 if typhh == 6 & adults_in_household_children == 1
replace Household2020 = 3 if (typhh == 2 | typhh == 3) & aantalpershh == 2
replace  Household2020 = 4 if (typhh == 4 | typhh == 5) & adults_in_household_children == 2
replace Household2020 = 5 if aantalpershh > 2 & aantalkindhh == 0
replace Household2020 = 6 if ((typhh == 4 | typhh == 5) & adults_in_household_children > 2) | (typhh == 6 & adults_in_household_children > 1)
replace Household2020 = 7 if typhh == 8
replace Household2020 = 8 if typhh == 7 & aantalkindhh == 0 & (aantalpershh == 1 | aantalpershh == 2)

*nu nog geen duplicates verwijderen; mogelijk verschuiven ze heen-en-terug naar dezelfde categorie
keep rinpersoons rinpersoon date_end date_start Household2020
*reshaping to merge 1:1 with the main 2020 dataset 
by rinpersoon: generate measurement = _n
reshape wide date_start date_end Household2020, i(rinpersoon) j(measurement)
gen start1 = date_start1
gen household1 = Household20201

foreach i of numlist 2/39 {
	display `i'
	local j = `i'-1
	gen start`i' = date_start`i' if Household2020`j' != Household2020`i' 
	replace start`i' = date_start`i' if Household2020`j' == Household2020`i' & date_start`i' >= date_end`j'+2
	gen household`i' = Household2020`i' if Household2020`j' != Household2020`i'
	replace household`i' = Household2020`i' if Household2020`j' == Household2020`i' & date_start`i' >= date_end`j'+2
}

foreach i of numlist 1/38 {
	display `i'
	local k = `i'+1
	gen stop`i' = date_end`i' if Household2020`k' != Household2020`i'
	replace stop`i' = date_end`i' if Household2020`k' == Household2020`i' & date_start`k' >= date_end`i'+2
}
gen stop39 = date_end39

reshape long date_start date_end Household2020 start stop household, i(rinpersoon) j(measurement)
drop if Household2020==.
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\HUISHOUDEN2020.dta", replace

*merging with the main dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V3.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\HUISHOUDEN2020.dta"
sort rinpersoon rinpersoons
rename SESWOATOTAALSCORE SESWOA2020
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V4.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020V4.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesMerged2020.dta"
drop merge_Comorbidities _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\CLRTI2020.dta"
drop _merge
...
format birthday %d
generate age2020 = (mdy(12,31,2020) - birthday)/365.25
*drop everyone that could not have been 18 for at least a day in our cohort pupulation (someone to be 18 at 30-12-2020 at the latest)
drop if age2020 < 18.00000
*Variabele maken voor Leeftijd op moment DBC 
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020FINAL.dta", replace
...
keep gbaherkomstgroepering landtiendeling landachtdeling etngrp LANDAKTUEEL12
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MERGED2020FINAL.dta", clear
...
keep if _merge == 3
drop _merge
*Merging with Postal codes for the complete datasets
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets Analyses\LongitudinalPOSTCODES.dta"

keep if _merge == 3
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\DATA2020Complete.dta", replace

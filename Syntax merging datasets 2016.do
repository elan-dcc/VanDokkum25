...
use "G:\Bevolking\GBAPERSOONTAB\2016\geconverteerde data\GBAPERSOONTAB 2016V1.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\PERSOONTAB2016.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\POSTCODES2016.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ADRESSEN2016.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ADRESSEN2016.dta", clear
merge m:1 rinobjectnummer soortobjectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\POSTCODES2016.dta"
...
drop if GBADATUMEINDEADRESHOUDING < date("20151231", "YMD") 
drop if GBADATUMAANVANGADRESHOUDING > date("20170101", "YMD")
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHABITANTS_THEHAGUE_2016.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\PERSOONTAB2016.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHABITANTS_THEHAGUE_2016.dta"

keep if _merge == 3 
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V1.dta", replace

* Merging previous file with SESWOAInhatab/Vehtab dataset and keeping matched or only in the first dataset to stick to the the Hague population and keep de definitive Merged file of 2018
*Export SESWOA external source (spss) to stata
*preparation of SESWOA
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SESWOA2016V3.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SESWOA2016.dta", replace
* SESWOA per household
*preparation of Inhatab
*use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2016.dta" to match rinpersoon to household
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\INHA2016TABV2.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHATAB2016.dta", replace
*income per household*
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2016.dta"
...
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHATAB2016.dta"

sort rinpersoon rinpersoons
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHATAB2016Linked.dta", replace
*household income per person*
*preparation of Vehtab
use "G:\InkomenBestedingen\VEHTAB\geconverteerde data\VEH2016TABV3.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\VEHTAB2016.dta", replace
*'vermogen'wealth per household*
*Merging the previous 2 linked files and merging with SESWOA to get de complete dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHATAB2016Linked.dta"
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\VEHTAB2016.dta"

sort rinpersoonhkw rinpersoonshkw
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\VermogenInkomen2016.dta", replace 
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\VermogenInkomen2016.dta", clear
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SESWOA2016.dta"


sort rinpersoon rinpersoons

drop _merge 
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SESMERGED2016.dta", replace
*household income and wealth per person, SESWOA per person *
*merging the main merged file with SESWOA
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V1.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SESMERGED2016.dta"
keep if _merge == 3 | _merge == 1
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V2.dta", replace
...
use "G:\Bevolking\GBAOVERLIJDENTAB\2016\geconverteerde data\GBAOVERLIJDENTA2016V1.DTA", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\OverlijdensDatum.dta", replace
*date of death per person*
*sorting of cause of death dataset
use "G:\GezondheidWelzijn\DOODOORZTAB\2016\geconverteerde data\DOODOORZ2016TABV1.dta", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Doodsoorzaak2016.dta", replace
*cause of death per person*

*linking cause of death to death date 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\OverlijdensDatum.dta"
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Doodsoorzaak2016.dta"

gen overlijdensdatum = date(GBADatumOverlijden, "YMD")
format overlijdensdatum %td
gen overleden_2016 = 1 if overlijdensdatum <= date("20170131", "YMD") & overlijdensdatum >= date("20160101", "YMD")
replace overleden_2016 = 0 if overleden_2016==.
tab _merge overleden_2016, m col

rename _merge merge_mortality
drop NNDLocationCode plovl statjaar overleden_2016 GBADatumOverlijden
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SterfteMERGED.dta", replace
*merging main merged file with mortality information
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V2.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SterfteMERGED.dta"
sort rinpersoon rinpersoons
drop if _merge == 2
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V3.dta", replace
...
use "G:\Bevolking\GBAHUISHOUDENSBUS\opgesplitste jaarbestanden\GBAHUISHOUDENSBUS2016.dta", clear
rename RINPERSOON rinpersoon
rename RINPERSOONS rinpersoons
sort rinpersoon rinpersoons
...
generate Household2016 = 1 if TYPHH == 1 & PLHH == 2 & AANTALPERSHH == 1 
replace Household2016 = 2 if TYPHH == 6 & adults_in_household_children == 1
replace Household2016 = 3 if (TYPHH == 2 | TYPHH == 3) & AANTALPERSHH == 2
replace  Household2016 = 4 if (TYPHH == 4 | TYPHH == 5) & adults_in_household_children == 2
replace Household2016 = 5 if AANTALPERSHH > 2 & AANTALKINDHH == 0
replace Household2016 = 6 if ((TYPHH == 4 | TYPHH == 5) & adults_in_household_children > 2) | (TYPHH == 6 & adults_in_household_children > 1)
replace Household2016 = 7 if TYPHH == 8
replace Household2016 = 8 if TYPHH == 7 & AANTALKINDHH == 0 & (AANTALPERSHH == 1 | AANTALPERSHH == 2)

*nu nog geen duplicates verwijderen; mogelijk verschuiven ze heen-en-terug naar dezelfde categorie
keep rinpersoons rinpersoon date_end date_start Household2016
*reshaping to merge 1:1 with the main 2016 dataset 
by rinpersoon: generate measurement = _n
reshape wide date_start date_end Household2016, i(rinpersoon) j(measurement)
gen start1 = date_start1
gen household1 = Household20161

foreach i of numlist 2/47 {
	display `i'
	local j = `i'-1
	gen start`i' = date_start`i' if Household2016`j' != Household2016`i' 
	replace start`i' = date_start`i' if Household2016`j' == Household2016`i' & date_start`i' >= date_end`j'+2
	gen household`i' = Household2016`i' if Household2016`j' != Household2016`i'
	replace household`i' = Household2016`i' if Household2016`j' == Household2016`i' & date_start`i' >= date_end`j'+2
}

foreach i of numlist 1/46 {
	display `i'
	local k = `i'+1
	gen stop`i' = date_end`i' if Household2016`k' != Household2016`i'
	replace stop`i' = date_end`i' if Household2016`k' == Household2016`i' & date_start`k' >= date_end`i'+2
}
gen stop47 = date_end47

reshape long date_start date_end Household2016 start stop household, i(rinpersoon) j(measurement)
drop if Household2016==.
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\HUISHOUDEN2016.dta", replace

*merging with the main dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V3.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\HUISHOUDEN2016.dta"
sort rinpersoon rinpersoons
rename SESWOATOTAALSCORE SESWOA2016
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V4.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016V4.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesMerged2016.dta"
drop merge_Comorbidities _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\CLRTI2016.dta"
drop _merge
*merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Exacerbations2016.dta"
*drop _merge
...
drop excl_HospitalAdmission* diff_HospitalAdmission*/
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MERGED2016FINAL.dta", replace
...
*merging datasets first with postal codes to only include people living in The Hague in 2017
use "G:\GezondheidWelzijn\MSZPRESTATIESVEKTTAB\2017\geconverteerde data\MSZPrestatiesVEKT2017TABV2.dta", clear
...
keep if _merge == 3 
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZ2017.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZZorgactiviteitenVEKT2017TABV1.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZZorgactiviteiten2017.dta", replace

*merge MSZ prestaties met MSZ zorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZ2017.dta"
sort VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest
merge m:m VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZZorgactiviteiten2017.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZMERGED2017.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2017\geconverteerde data\MEDICIJN2017TABV1.dta", clear
sort rinpersoon rinpersoons
...
recode ATC4_category (16/17=1) (171/174=2) (135=3) (130/131=4) (106=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MEDICIJNEN2017.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MSZMERGED2017.dta", clear
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Comorbidities_DTC_2017_temp.dta", replace
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Comorbidities_DTC_2017_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ `comorb'_DTC_2017_temp.dta", replace
}

use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Neoplastic_Disease_DTC_2017_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Liver_Disease_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Congestive_HF_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Cerebrovascular_Disease_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Renal_Disease_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Pulmonary_Disease_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Dementia_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Neurologic_Disease_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Diabetes_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ HIV_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Immunocompromised_DTC_2017_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ Cardiovascular_Disease_other_DTC_2017_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesDBC2017.dta", replace

*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MEDICIJNEN2017.dta", clear
generate Diabetes = .
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesMED2017.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesDBC2017.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesMED2017.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesMerged2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI&Asthma_COPD2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SEH2017.dta", replace
...
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Beeldvorming2017.dta", replace

*Gecombineerde dataset LRTI&Asthma_COPD + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI&Asthma_COPD2017.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer 
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SEH2017.dta"
keep if _merge == 3
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_SEH2017.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_SEH2017.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Beeldvorming2017.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_COPD_SEH_Beeld2017.dta", replace
*dropping if Asthma/COPD to have a dataset with only LRTI
keep if LRTI == 1
drop Asthma_COPD 
/*
*droping duplicate observations in the same DBC traject, as we've already established if someone has received SEH + beeldvorming in the same zorgtraject with same date of opened DBC*/
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_SEH_Beeld2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\HospitalAdmissions2017_all.dta", replace

*Merging datasets for LRTI, Hospital Admissions, s and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_SEH_Beeld2017.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\InclusionDeath2017.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\LRTI_SEH_Beeld2017.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\HospitalAdmissions2017_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons 
...
foreach numrti of numlist 1/3 {
	foreach numopn of numlist 1/179 {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\InclusionsHospital2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\CLRTI2017.dta", replace

...
*merging datasets first with postal codes to only include people living in The Hague in 2020
use "G:\GezondheidWelzijn\MSZPRESTATIESVEKTTAB2020\geconverteerde data\MSZPrestatiesVEKT2020TABV3.dta", clear
...
keep if _merge == 3 
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZ2020.dta", replace
...
use "G:\GezondheidWelzijn\MSZZORGACTIVITEITENVEKTTAB2020\geconverteerde data\MSZZorgactiviteitenVEKT2020TABV2.dta"
sort rinpersoon rinpersoons
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\INHABITANTS_THEHAGUE_2020.dta"
keep if _merge == 3 
drop _merge
sort VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZZorgactiviteiten2020.dta", replace

*merge MSZ prestaties met MSZ zorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZ2020.dta"
sort VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest
merge m:m VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZZorgactiviteiten2020.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZMERGED2020.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2020\geconverteerde data\MEDICIJN2020TABV2.dta", clear
sort rinpersoon rinpersoons
...
recode ATC4_category (16/17=1) (172/175=2) (135=3) (130/131=4) (106=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MEDICIJNEN2020.dta", replace

*New seperate databases for CAP+ILI, COVID, Comorbidities, SEH, beeldvorming en opname

*New dataset for comorbidities 
*nieuwe variabele Neoplastic Disease
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZMERGED2020.dta", clear
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Comorbidities_DTC_2020_temp.dta", replace
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Comorbidities_DTC_2020_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ `comorb'_DTC_2020_temp.dta", replace
}
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Neoplastic_Disease_DTC_2020_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Liver_Disease_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Congestive_HF_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Cerebrovascular_Disease_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Renal_Disease_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Pulmonary_Disease_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Dementia_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Neurologic_Disease_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Diabetes_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ HIV_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Immunocompromised_DTC_2020_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ Cardiovascular_Disease_other_DTC_2020_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesDBC2020.dta", replace


*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MEDICIJNEN2020.dta", clear
generate Diabetes = .
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesMED2020.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesDBC2020.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesMED2020.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\ComorbiditiesMerged2020.dta", replace

* Preparation for Datasets for CLRTI and COVID
* nieuwe variabele voor CAP+ILI (LRTI) + COVID
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZMERGED2020.dta", clear
*MSZ to include only needed comorbidities and diagnoses
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI&COVID2020.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SEH2020.dta", replace
...
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Beeldvorming2020.dta", replace

*Gecombineerde dataset LRTI + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI&COVID2020.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\SEH2020.dta"
keep if _merge == 3 
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_SEH2020.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_SEH2020.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
* merging based on rinpersoon rinpersoons and the Zorgtrajectnummer to link a SEH visit belonging to a certain corresponding Zorgtraject and person in the other dataset
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\Beeldvorming2020.dta"
keep if _merge == 3
drop _merge
destring VEKTMSZZorgactiviteit, replace
* Only keeping observations with SEH or Beeldvorming
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_COVID_SEH_Beeld2020.dta", replace


*Dataset voor alle opnames, ook niet-LRTI*/
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\MSZMERGED2020.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\HospitalAdmissions2020_all.dta", replace

*Merging datasets for LRTI, Hospital Admissions, ELV, Nursing Home admissions and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_COVID_SEH_Beeld2020.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\InclusionDeath2020.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_COVID_SEH_Beeld2020.dta", clear
sort rinpersoon rinpersoons
merge 1:m rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\HospitalAdmissions2020_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons
...
foreach numrti of numlist 1/2 {
	foreach numopn of numlist 1/203 {
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\InclusionsHospital2020.dta", replace

*merge the individual inclusion datasets with eachother
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\LRTI_COVID_SEH_Beeld2020.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\InclusionDeath2020.dta"

drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\InclusionsHospital2020.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2020\CLRTI2020.dta", replace

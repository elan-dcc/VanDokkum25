...
use "G:\Bevolking\GBAPERSOONTAB\2017\geconverteerde data\GBAPERSOON2017TABV1.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\PERSOONTAB2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\POSTCODES2017.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ADRESSEN2017.dta", replace
...
merge m:1 rinobjectnummer soortobjectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\POSTCODES2017.dta"
...
drop if GBADATUMEINDEADRESHOUDING < date("20161231", "YMD") 
drop if GBADATUMAANVANGADRESHOUDING > date("20180101", "YMD")
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHABITANTS_THEHAGUE_2017.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\PERSOONTAB2017.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHABITANTS_THEHAGUE_2017.dta"

keep if _merge == 3 
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V1.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SESWOA2017V3.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SESWOA2017.dta", replace
* SESWOA per household
*preparation of Inhatab
*use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2017.dta" to match rinpersoon to household
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\INHA2017TABV2.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHATAB2017.dta", replace
*income per household*
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2017.dta"
...
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHATAB2017.dta"

sort rinpersoon rinpersoons
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHATAB2017Linked.dta", replace
*household income per person*
*preparation of Vehtab
use "G:\InkomenBestedingen\VEHTAB\geconverteerde data\VEH2017TABV3.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\VEHTAB2017.dta", replace
*'vermogen'wealth per household*
*Merging the previous 2 linked files and merging with SESWOA to get de complete dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHATAB2017Linked.dta"
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\VEHTAB2017.dta"

sort rinpersoonhkw rinpersoonshkw
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\VermogenInkomen2017.dta", replace 
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\VermogenInkomen2017.dta", clear
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SESWOA2017.dta"


sort rinpersoon rinpersoons

drop _merge 
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SESMERGED2017.dta", replace
*household income and wealth per person, SESWOA per person *
*merging the main merged file with SESWOA
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V1.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SESMERGED2017.dta"
keep if _merge == 3 | _merge == 1
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V2.dta", replace
...
use "G:\Bevolking\GBAOVERLIJDENTAB\2017\geconverteerde data\GBAOVERLIJDENTAB2017V1.DTA", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\OverlijdensDatum.dta", replace
*date of death per person*
*sorting of cause of death dataset
use "G:\GezondheidWelzijn\DOODOORZTAB\2017\geconverteerde data\DOODOORZ2017TABV1.dta", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Doodsoorzaak2017.dta", replace
*cause of death per person*
*HB: hier kunnen alle 'externe doodsoorzaak' variabelen uit 
*linking cause of death to death date 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\OverlijdensDatum.dta"
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Doodsoorzaak2017.dta"

gen overlijdensdatum = date(GBADatumOverlijden, "YMD")
format overlijdensdatum %td
gen overleden_2017 = 1 if overlijdensdatum <= date("20180131", "YMD") & overlijdensdatum >= date("20170101", "YMD")
replace overleden_2017 = 0 if overleden_2017==.
tab _merge overleden_2017, m col

rename _merge merge_mortality
drop NNDLocationCode plovl statjaar overleden_2017 GBADatumOverlijden
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SterfteMERGED.dta", replace
*merging main merged file with mortality information
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V2.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\SterfteMERGED.dta"
sort rinpersoon rinpersoons
drop if _merge == 2
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V3.dta", replace
...
use "G:\Bevolking\GBAHUISHOUDENSBUS\opgesplitste jaarbestanden\GBAHUISHOUDENSBUS2017.dta", clear
rename RINPERSOON rinpersoon
rename RINPERSOONS rinpersoons
sort rinpersoon rinpersoons
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\INHABITANTS_THEHAGUE_2017.dta"
keep if _merge == 3
drop _merge
sort rinpersoon rinpersoons
...
generate Household2017 = 1 if TYPHH == 1 & PLHH == 2 & AANTALPERSHH == 1 
replace Household2017 = 2 if TYPHH == 6 & adults_in_household_children == 1
replace Household2017 = 3 if (TYPHH == 2 | TYPHH == 3) & AANTALPERSHH == 2
replace	Household2017 = 4 if (TYPHH == 4 | TYPHH == 5) & adults_in_household_children == 2
replace Household2017 = 5 if AANTALPERSHH > 2 & AANTALKINDHH == 0
replace Household2017 = 6 if ((TYPHH == 4 | TYPHH == 5) & adults_in_household_children > 2) | (TYPHH == 6 & adults_in_household_children > 1)
replace Household2017 = 7 if TYPHH == 8
replace Household2017 = 8 if TYPHH == 7 & AANTALKINDHH == 0 & (AANTALPERSHH == 1 | AANTALPERSHH == 2)

*nu nog geen duplicates verwijderen; mogelijk verschuiven ze heen-en-terug naar dezelfde categorie
keep rinpersoons rinpersoon date_end date_start Household2017
*reshaping to merge 1:1 with the main 2017 dataset 
by rinpersoon: generate measurement = _n
reshape wide date_start date_end Household2017, i(rinpersoon) j(measurement)
gen start1 = date_start1
gen household1 = Household20171

foreach i of numlist 2/30 {
	display `i'
	local j = `i'-1
	gen start`i' = date_start`i' if Household2017`j' != Household2017`i' 
	replace start`i' = date_start`i' if Household2017`j' == Household2017`i' & date_start`i' >= date_end`j'+2
	gen household`i' = Household2017`i' if Household2017`j' != Household2017`i'
	replace household`i' = Household2017`i' if Household2017`j' == Household2017`i' & date_start`i' >= date_end`j'+2
}

foreach i of numlist 1/29 {
	display `i'
	local k = `i'+1
	gen stop`i' = date_end`i' if Household2017`k' != Household2017`i'
	replace stop`i' = date_end`i' if Household2017`k' == Household2017`i' & date_start`k' >= date_end`i'+2
}
gen stop30 = date_end30

reshape long date_start date_end Household2017 start stop household, i(rinpersoon) j(measurement)
drop if Household2017==.
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\HUISHOUDEN2017.dta", replace

*merging with the main dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V3.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\HUISHOUDEN2017.dta"
sort rinpersoon rinpersoons
rename SESWOATOTAALSCORE SESWOA2017
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V4.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017V4.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\ComorbiditiesMerged2017.dta"
drop merge_Comorbidities _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\CLRTI2017.dta"
drop _merge
*merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\Exacerbations2017.dta"
*drop _merge
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2017\MERGED2017FINAL.dta", replace
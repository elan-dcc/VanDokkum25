...
*merging datasets first with postal codes to only include people living in The Hague in 2016
use "G:\GezondheidWelzijn\MSZPRESTATIESVEKTTAB\2016\geconverteerde data\MSZPrestatiesVEKT2016TABV2.dta", clear
...
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\INHABITANTS_THEHAGUE_2016.dta"
keep if _merge == 3 
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZ2016.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZZorgactiviteitenVEKT2016TABV1.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZZorgactiviteiten2016.dta", replace

*merge MSZ prestaties met MSZ zorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZ2016.dta"
sort VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest
merge m:m VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZZorgactiviteiten2016.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZMERGED2016.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2016\geconverteerde data\MEDICIJN2016TABV1.dta", clear
sort rinpersoon rinpersoons
...
recode ATC4_category (17/18=1) (178/171=2) (141=3) (136/137=4) (110=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MEDICIJNEN2016.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MSZMERGED2016.dta", clear
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Comorbidities_DTC_2016_temp.dta", replace
/*HB: voorstel om dit anders te doen zonder data te verliezen*/
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Comorbidities_DTC_2016_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ `comorb'_DTC_2016_temp.dta", replace
}

use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Neoplastic_Disease_DTC_2016_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Liver_Disease_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Congestive_HF_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Cerebrovascular_Disease_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Renal_Disease_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Pulmonary_Disease_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Dementia_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Neurologic_Disease_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Diabetes_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ HIV_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Immunocompromised_DTC_2016_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ Cardiovascular_Disease_other_DTC_2016_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesDBC2016.dta", replace

*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\MEDICIJNEN2016.dta", clear
generate Diabetes = .
generate Immunocompromised = .
recode Diabetes (.=1) if ATC4_category1 == 1 | ATC4_category2 == 1 | ATC4_category3 == 1 | ATC4_category4 == 1 | ATC4_category5 == 1 
recode Immunocompromised (.=1)  if ATC4_category1 == 3 | ATC4_category2 == 3 | ATC4_category3 == 3 | ATC4_category4 == 3 | ATC4_category5 == 3 | ATC4_category1 == 4 | ATC4_category2 == 4 | ATC4_category3 == 4 | ATC4_category4 == 4 | ATC4_category5 == 4 | ATC4_category1 == 5 | ATC4_category2 == 5 | ATC4_category3 == 5 | ATC4_category4 == 5 | ATC4_category5 == 5 
keep if Diabetes == 1 | Immunocompromised == 1 
drop ATC41 ATC4_category1 ATC42 ATC4_category2 ATC43 ATC4_category3 ATC44 ATC4_category4 ATC45 ATC4_category5 
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesMED2016.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesDBC2016.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesMED2016.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\ComorbiditiesMerged2016.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI&Asthma_COPD2016.dta", replace
...
/*je wilt weten bij welk zorgtraject een SEHbezoek is geweest? Dan zou ik de andere variabelen weglaten, anders krijg je problemen met mergen (bijv overschrijven van bestaande info)
Ook zijn er meerdere SEH bezoeken per zorgtraject zie ik*/
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SEH2016.dta", replace
...
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Beeldvorming2016.dta", replace

*Gecombineerde dataset LRTI&Asthma_COPD + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI&Asthma_COPD2016.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer 
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SEH2016.dta"
keep if _merge == 3
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_SEH2016.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_SEH2016.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\Beeldvorming2016.dta"
*HB hier selectie van patienten met SEH bezoek én beeldvorming binnen LRTI/ astma&COPD traject*
keep if _merge == 3
drop _merge
...
keep rinpersoons rinpersoon DTC_stringed DTC_codes LRTI Asthma_COPD BeginLRTIDBC EindLRTIDBC LRTI_SEH_Beeld date_LRTI_SEH_Beeld VEKTMSZZorgtrajectnummer
drop if LRTI_SEH_Beeld!=1
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_COPD_SEH_Beeld2016.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_SEH_Beeld2016.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\HospitalAdmissions2016_all.dta", replace


*Merging datasets for LRTI, Hospital Admissions and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_SEH_Beeld2016.dta", clear
*merging with the mortality file to include deaths
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\SterfteMERGED.dta"
...
*generate diff_Deathdate6 = overlijdensdatum - BeginLRTIDBC6
...
*generate CLRTI_Death6 = 1 if diff_Deathdate6 < 14 & diff_Deathdate6 >=0
recode CLRTI_Death1 (.=0)
recode CLRTI_Death2 (.=0)
recode CLRTI_Death3 (.=0)
*recode CLRTI_Death4 (.=0)
*recode CLRTI_Death5 (.=0)
*recode CLRTI_Death6 (.=0)
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\InclusionDeath2016.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\LRTI_SEH_Beeld2016.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\HospitalAdmissions2016_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons 
...
foreach numrti of numlist 1/3 {
	foreach numopn of numlist 1/161 {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\InclusionsHospital2016.dta", replace

ort rinpersoon rinpersoons
...
*gen diff_Hospitalisation5 = BeginLRTIDBC6 - BeginLRTIDBC5
...
*replace BeginLRTIDBC6 =. if diff_Hospitalisation5 < 14
*replace EindLRTIDBC6 =. if diff_Hospitalisation5 < 14
*replace date_LRTI_SEH_Beeld6 =. if diff_Hospitalisation5 < 14
*replace CLRTI_adm6 =. if diff_Hospitalisation5 < 14
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2016\CLRTI2016.dta", replace

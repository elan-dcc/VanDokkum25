...
*merging datasets first with postal codes to only include people living in The Hague in 2018
use "G:\GezondheidWelzijn\MSZPRESTATIESVEKTTAB\2018\geconverteerde data\MSZPrestatiesVEKT2018TABV3.dta", clear
...
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHABITANTS_THEHAGUE_2018.dta"
keep if _merge == 3 
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZ2018.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZZorgactiviteitenVEKT2018TABV2.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZZorgactiviteiten2018.dta", replace

*merge MSZ prestaties met MSZ zorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZ2018.dta"
sort VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest
merge m:m VEKTMSZKoppelIDPrestZa VEKTMSZBeginjaarPrest using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZZorgactiviteiten2018.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZMERGED2018.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2018\geconverteerde data\MEDICIJN2018TABV1.dta", clear
sort rinpersoon rinpersoons
...
recode ATC4_category (16/17=1) (169/172=2) (133=3) (128/129=4) (104=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MEDICIJNEN2018.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MSZMERGED2018.dta", clear
...
foreach val of numlist 30303310309 31306000601 32212001201 32212001241 32214001403 33527000272  {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Comorbidities_DTC_2018_temp.dta", replace
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Comorbidities_DTC_2018_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ `comorb'_DTC_2018_temp.dta", replace
}

use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Neoplastic_Disease_DTC_2018_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Liver_Disease_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Congestive_HF_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Cerebrovascular_Disease_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Renal_Disease_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Pulmonary_Disease_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Dementia_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Neurologic_Disease_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Diabetes_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ HIV_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Immunocompromised_DTC_2018_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ Cardiovascular_Disease_other_DTC_2018_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesDBC2018.dta", replace

*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MEDICIJNEN2018.dta", clear
generate Diabetes = .
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesMED2018.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesDBC2018.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesMED2018.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesMerged2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI&Asthma_COPD2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SEH2018.dta", replace
...
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Beeldvorming2018.dta", replace

*Gecombineerde dataset LRTI&Asthma_COPD + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI&Asthma_COPD2018.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer 
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SEH2018.dta"
keep if _merge == 3
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_SEH2018.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_SEH2018.dta", clear
sort rinpersoon rinpersoons VEKTMSZZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons VEKTMSZZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Beeldvorming2018.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_COPD_SEH_Beeld2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_SEH_Beeld2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\HospitalAdmissions2018_all.dta", replace


*Merging datasets for LRTI, Hospital Admissions, ELV, Nursing Home admissions and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_SEH_Beeld2018.dta", clear
*merging with the mortality file to include deaths
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SterfteMERGED.dta"
...
/*per SEH bezoek mogelijke gecompliceerde uitkomst, dus 1-3*/
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\InclusionDeath2018.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\LRTI_SEH_Beeld2018.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\HospitalAdmissions2018_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons 
...
foreach numrti of numlist 1/3 {
	foreach numopn of numlist 1/148 {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\InclusionsHospital2018.dta", replace


sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\InclusionsHospital2018.dta"
drop _merge
sort rinpersoon rinpersoons
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\CLRTI2018.dta", replace

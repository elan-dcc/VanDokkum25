...
use "G:\Bevolking\GBAPERSOONTAB\2018\geconverteerde data\GBAPERSOON2018TABV2.dta"
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\PERSOONTAB2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\POSTCODES2018.dta", replace
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ADRESSEN2018.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ADRESSEN2018.dta", clear
merge m:1 rinobjectnummer soortobjectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\POSTCODES2018.dta"
...
drop if GBADATUMEINDEADRESHOUDING < date("20171231", "YMD") 
drop if GBADATUMAANVANGADRESHOUDING > date("20190101", "YMD")
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHABITANTS_THEHAGUE_2018.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\PERSOONTAB2018.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHABITANTS_THEHAGUE_2018.dta"

keep if _merge == 3 
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V1.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SESWOA2018V3.dta", clear
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SESWOA2018.dta", replace
* SESWOA per household
*preparation of Inhatab
*use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2018.dta" to match rinpersoon to household
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\INHA2018TABV2.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHATAB2018.dta", replace
*income per household*
use "G:\InkomenBestedingen\INHATAB\geconverteerde data\KOPPELPERSOONHUISHOUDEN2018.dta"
...
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHATAB2018.dta"

sort rinpersoon rinpersoons
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHATAB2018Linked.dta", replace
*household income per person*
*preparation of Vehtab
use "G:\InkomenBestedingen\VEHTAB\geconverteerde data\VEH2018TABV3.DTA"
...
sort rinpersoonhkw rinpersoonshkw
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\VEHTAB2018.dta", replace
*'vermogen'wealth per household*

*Merging the previous 2 linked files and merging with SESWOA to get de complete dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\INHATAB2018Linked.dta"
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\VEHTAB2018.dta"

sort rinpersoonhkw rinpersoonshkw
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\VermogenInkomen2018.dta", replace 
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\VermogenInkomen2018.dta", clear
merge m:1 rinpersoonhkw rinpersoonshkw using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SESWOA2018.dta"


sort rinpersoon rinpersoons

drop _merge 
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SESMERGED2018.dta", replace
*household income and wealth per person, SESWOA per person *
*merging the main merged file with SESWOA
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V1.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SESMERGED2018.dta"
keep if _merge == 3 | _merge == 1
drop _merge
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V2.dta", replace
...
use "G:\Bevolking\GBAOVERLIJDENTAB\2018\geconverteerde data\GBAOVERLIJDEN2018TABV1.DTA", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\OverlijdensDatum.dta", replace
*date of death per person*
*sorting of cause of death dataset
use "G:\GezondheidWelzijn\DOODOORZTAB\2018\geconverteerde data\DOODOORZ2018TABV2.dta", clear
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Doodsoorzaak2018.dta", replace
*cause of death per person*
*HB: hier kunnen alle 'externe doodsoorzaak' variabelen uit 
*linking cause of death to death date 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\OverlijdensDatum.dta"
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Doodsoorzaak2018.dta"

gen overlijdensdatum = date(GBADatumOverlijden, "YMD")
format overlijdensdatum %td
gen overleden_2018 = 1 if overlijdensdatum <= date("20190131", "YMD") & overlijdensdatum >= date("20180101", "YMD")
replace overleden_2018 = 0 if overleden_2018==.
tab _merge overleden_2018, m col

rename _merge merge_mortality
drop NNDLocationCode plovl statjaar overleden_2018 GBADatumOverlijden
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SterfteMERGED.dta", replace
*merging main merged file with mortality information
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V2.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\SterfteMERGED.dta"
sort rinpersoon rinpersoons
drop if _merge == 2
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V3.dta", replace
...
use "G:\Bevolking\GBAHUISHOUDENSBUS\opgesplitste jaarbestanden\GBAHUISHOUDENSBUS2018.dta", clear
rename RINPERSOON rinpersoon
rename RINPERSOONS rinpersoons
sort rinpersoon rinpersoons
...
generate Household2018 = 1 if TYPHH == 1 & PLHH == 2 & AANTALPERSHH == 1 
replace Household2018 = 2 if TYPHH == 6 & adults_in_household_children == 1
replace Household2018 = 3 if (TYPHH == 2 | TYPHH == 3) & AANTALPERSHH == 2
replace  Household2018 = 4 if (TYPHH == 4 | TYPHH == 5) & adults_in_household_children == 2
replace Household2018 = 5 if AANTALPERSHH > 2 & AANTALKINDHH == 0
replace Household2018 = 6 if ((TYPHH == 4 | TYPHH == 5) & adults_in_household_children > 2) | (TYPHH == 6 & adults_in_household_children > 1)
replace Household2018 = 7 if TYPHH == 8
replace Household2018 = 8 if TYPHH == 7 & AANTALKINDHH == 0 & (AANTALPERSHH == 1 | AANTALPERSHH == 2)

*nu nog geen duplicates verwijderen; mogelijk verschuiven ze heen-en-terug naar dezelfde categorie
keep rinpersoons rinpersoon date_end date_start Household2018
*reshaping to merge 1:1 with the main 2018 dataset 
by rinpersoon: generate measurement = _n
reshape wide date_start date_end Household2018, i(rinpersoon) j(measurement)
gen start1 = date_start1
gen household1 = Household20181

foreach i of numlist 2/28 {
	display `i'
	local j = `i'-1
	gen start`i' = date_start`i' if Household2018`j' != Household2018`i' 
	replace start`i' = date_start`i' if Household2018`j' == Household2018`i' & date_start`i' >= date_end`j'+2
	gen household`i' = Household2018`i' if Household2018`j' != Household2018`i'
	replace household`i' = Household2018`i' if Household2018`j' == Household2018`i' & date_start`i' >= date_end`j'+2
}

foreach i of numlist 1/27 {
	display `i'
	local k = `i'+1
	gen stop`i' = date_end`i' if Household2018`k' != Household2018`i'
	replace stop`i' = date_end`i' if Household2018`k' == Household2018`i' & date_start`k' >= date_end`i'+2
}
gen stop28 = date_end28

reshape long date_start date_end Household2018 start stop household, i(rinpersoon) j(measurement)
drop if Household2018==.
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\HUISHOUDEN2018.dta", replace

*merging with the main dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V3.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\HUISHOUDEN2018.dta"
sort rinpersoon rinpersoons
rename SESWOATOTAALSCORE SESWOA2018
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V4.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018V4.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\ComorbiditiesMerged2018.dta"
drop merge_Comorbidities _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\CLRTI2018.dta"
drop _merge
*merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\Exacerbations2018.dta"
*drop _merge
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2018\MERGED2018FINAL.dta", replace

...
*merging the standard MSZSubtrajecten DTC dataset with the MSZGeleverdZorgprofiel dataset to link a zorgactiviteit to a DBC in order to link a possibl admission to a diagnosis
*merging datasets first with postal codes to only include people living in The Hague in 2015
use "G:\GezondheidWelzijn\MSZSUBTRAJECTENTAB\geconverteerde data\MSZSubtrajecten2015TABV2.dta", clear
drop MSZSTRBehandelendSpecialisme MSZSTRZorgtype MSZSTRSpecialismeZorgvraagCombin MSZSTRVerkoopprijsDBC MSZSTRHonorariumDBC MSZSTRDeclaratiecode MSZSTRDeclaratiesetnummer MSZSTRHoofddiagnoseICD10 MSZSTRSoortinstelling4catJJJJ MSZSTROphooggewicht
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\INHABITANTS_THEHAGUE_2015.dta"
keep if _merge == 3 
drop _merge
sort MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZ2015.dta", replace

* sorting the MSZGeleverdzorgprofiel dataset to link them to each other based on the specific dtc (has to be exported from another data source)
use "G:\GezondheidWelzijn\MSZGELEVERDZORGPROFIELTAB\geconverteerde data\MSZGeleverdZorgprofiel2015TABV2.dta", clear
sort rinpersoon rinpersoons
merge m:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\INHABITANTS_THEHAGUE_2015.dta"
keep if _merge == 3 
drop _merge MSZGZPUitvoerendSpecialisme MSZGZPDeclaratiecode MSZGZPVerkoopprijsAOOZP MSZGZPHonorariumAOOZP
rename MSZGZPInstelling MSZSTRInstelling
rename MSZGZPLocatie MSZSTRLocatie
rename MSZGZPDBCSubtrajectnummer MSZSTRDBCSubtrajectnummer
sort MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZZorgactiviteiten2015.dta", replace

*merge MSZSubtrajecten met MSZzorgactiviteit
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZ2015.dta"
merge m:m MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZZorgactiviteiten2015.dta"
drop _merge
sort rinpersoon rinpersoons
generate DTC_stringed = MSZSTRSpecialismeDiagnoseCombin
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZMERGED2015.dta", replace

*MSZ merge with Medication to combine for the specification of comorbidities
*sorting of medication use dataset
use "G:\GezondheidWelzijn\MEDICIJNTAB\2015\geconverteerde data\MEDICIJN2015TABV1.dta", clear
...
recode ATC4_category (16/17=1) (176/179=2) (139=3) (134 135=4) (108=5) (else=0)
...
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MEDICIJNEN2015.dta", replace
...
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZMERGED2015.dta", clear
...
*drop all variables not needed for analyses involving comorbidities
drop MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer MSZSTRHoofdtraject MSZSTRDBCZorgproduct MSZGZPZorgactiviteitVolgnummer MSZGZPZorgactiviteitDatum MSZGZPZorgactiviteit MSZGZPAantal MSZSTREinddatumDBC MSZSTRSpecialismeDiagnoseCombina
generate BeginZorgtraject = date(MSZSTRBegindatumDBC, "YMD")
format BeginZorgtraject %td
drop MSZSTRBegindatumDBC
...
drop MSZSTRZorgtrajectnummer DTC_stringed DTC_codes
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\Comorbidities_DTC_2015_temp.dta", replace
...
foreach comorb in Neoplastic_Disease Liver_Disease Congestive_HF Cerebrovascular_Disease Renal_Disease Pulmonary_Disease Dementia Neurologic_Disease Diabetes HIV Immunocompromised Cardiovascular_Disease_other {
	use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\Comorbidities_DTC_2015_temp.dta", clear
	keep rinpersoon rinpersoons BeginZorgtraject `comorb'
	rename BeginZorgtraject St`comorb'
	keep if `comorb'==1
	save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ `comorb'_DTC_2015_temp.dta", replace
}

use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Neoplastic_Disease_DTC_2015_temp.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Liver_Disease_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Congestive_HF_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Cerebrovascular_Disease_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Renal_Disease_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Pulmonary_Disease_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Dementia_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Neurologic_Disease_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Diabetes_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ HIV_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Immunocompromised_DTC_2015_temp.dta"
drop _merge
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ Cardiovascular_Disease_other_DTC_2015_temp.dta"
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ComorbiditiesDBC2015.dta", replace

*Comorbidities based on medication
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MEDICIJNEN2015.dta", clear
generate Diabetes = .
generate Immunocompromised = .
recode Diabetes (.=1) if ATC4_category1 == 1 | ATC4_category2 == 1 | ATC4_category3 == 1 | ATC4_category4 == 1 | ATC4_category5 == 1 | ATC4_category6 == 1 
recode Immunocompromised (.=1)  if ATC4_category1 == 3 | ATC4_category2 == 3 | ATC4_category3 == 3 | ATC4_category4 == 3 | ATC4_category5 == 3 | ATC4_category6 == 3 | ATC4_category1 == 4 | ATC4_category2 == 4 | ATC4_category3 == 4 | ATC4_category4 == 4 | ATC4_category5 == 4 | ATC4_category6 == 4 | ATC4_category1 == 5 | ATC4_category2 == 5 | ATC4_category3 == 5 | ATC4_category4 == 5 | ATC4_category5 == 5 | ATC4_category6 == 5 
keep if Diabetes == 1 | Immunocompromised == 1 
drop ATC41 ATC4_category1 ATC42 ATC4_category2 ATC43 ATC4_category3 ATC44 ATC4_category4 ATC45 ATC4_category5 ATC46 ATC4_category6 
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ComorbiditiesMED2015.dta", replace
*Merging DBC comorbidities and Medication comorbidites
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ComorbiditiesDBC2015.dta", clear
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ComorbiditiesMED2015.dta"
rename _merge merge_Comorbidities
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\ComorbiditiesMerged2015.dta", replace
...
gen COPD2 = .
foreach val of numlist 31306000601 32212001201 32212001202 32212001203 32212001241 30303310309 {
	replace COPD2 = 1 if Asthma_COPD ==`val'
}
drop Asthma_COPD
rename COPD2 Asthma_COPD
keep if LRTI == 1 | Asthma_COPD == 1
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI&Asthma_COPD2015.dta", replace

*New dataset for SEH
*nieuwe variabele om SEH-bezoek te specificeren
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZMERGED2015.dta", clear
generate SEH = MSZGZPZorgactiviteit
destring SEH, replace
recode SEH (190015=1) (else = 0)
keep if SEH == 1
gen datum_SEH = MSZGZPZorgactiviteitDatum

keep rinpersoon rinpersoons MSZSTRZorgtrajectnummer SEH datum_SEH
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
duplicates drop

by rinpersoon rinpersoons MSZSTRZorgtrajectnummer: generate measurement = _n
reshape wide SEH datum_SEH, i(rinpersoon rinpersoons MSZSTRZorgtrajectnummer) j(measurement) 
*alle SEH data per zorgtraject*
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\SEH2015.dta", replace

*New dataset for beeldvorming
*nieuwe variabele om Beeldvorming te specificeren
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZMERGED2015.dta", clear
generate Beeldvorming = MSZGZPZorgactiviteit
...
sort rinpersoon rinpersoons
gen datum_beeldvorming = MSZGZPZorgactiviteitDatum

keep rinpersoon rinpersoons MSZSTRZorgtrajectnummer Beeldvorming datum_beeldvorming
duplicates drop
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer 

by rinpersoon rinpersoons MSZSTRZorgtrajectnummer: generate measurement = _n
reshape wide Beeldvorming datum_beeldvorming, i(rinpersoon rinpersoons MSZSTRZorgtrajectnummer) j(measurement) 
*alle Beeldvorming data per zorgtraject*
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\Beeldvorming2015.dta", replace

*Gecombineerde dataset LRTI&Asthma_COPD + SEH + Beeldvorming
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI&Asthma_COPD2015.dta", clear
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons MSZSTRZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\SEH2015.dta"
keep if _merge == 3
drop _merge
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_SEH2015.dta", replace
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_SEH2015.dta", clear
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer
...
merge m:1 rinpersoon rinpersoons MSZSTRZorgtrajectnummer using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\Beeldvorming2015.dta"
...
generate BeginLRTIDBC = date(MSZSTRBegindatumDBC, "YMD")
format BeginLRTIDBC %td
generate EindLRTIDBC = date(MSZSTREinddatumDBC, "YMD")
format EindLRTIDBC %td
drop MSZSTRBegindatumDBC MSZSTREinddatumDBC

drop MSZSTRInstelling MSZSTRLocatie MSZSTRDBCSubtrajectnummer MSZSTRHoofdtraject MSZSTRDBCZorgproduct MSZGZPZorgactiviteitVolgnummer MSZGZPZorgactiviteitDatum MSZGZPZorgactiviteit MSZGZPAantal MSZSTRSpecialismeDiagnoseCombina
...
keep rinpersoons rinpersoon DTC_stringed DTC_codes LRTI Asthma_COPD BeginLRTIDBC EindLRTIDBC LRTI_SEH_Beeld date_LRTI_SEH_Beeld MSZSTRZorgtrajectnummer
drop if LRTI_SEH_Beeld!=1
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_COPD_SEH_Beeld2015.dta", replace
...
reshape wide MSZSTRZorgtrajectnummer DTC_codes BeginLRTIDBC EindLRTIDBC LRTI_SEH_Beeld date_LRTI_SEH_Beeld , i(rinpersoon) j(measurement)
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_SEH_Beeld2015.dta", replace



*New dataset for Hospital admission specific for LRTI DTC
*nieuwe variabele om opname te specificeren
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\MSZMERGED2015.dta", clear
generate Opname = 1 if MSZSTRSettingZPK =="3"
keep if Opname == 1
sort rinpersoon rinpersoons

generate BeginDBCopname = date(MSZSTRBegindatumDBC, "YMD")
format BeginDBCopname %td
generate EindDBCopname = date(MSZSTREinddatumDBC, "YMD")
format EindDBCopname %td
drop MSZSTRBegindatumDBC MSZSTREinddatumDBC

keep rinpersoon rinpersoons MSZSTRZorgtrajectnummer Opname BeginDBCopname EindDBCopname
sort rinpersoon rinpersoons MSZSTRZorgtrajectnummer BeginDBCopname
duplicates drop

by rinpersoon rinpersoons: generate measurement = _n
drop Opname MSZSTRZorgtrajectnummer
sort rinpersoon rinpersoons
reshape wide BeginDBCopname EindDBCopname, i(rinpersoon rinpersoons) j(measurement)
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\HospitalAdmissions2015_all.dta", replace



*Merging datasets for LRTI, Hospital Admissions and mortality to create a CLRTI dataset
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_SEH_Beeld2015.dta", clear
...
*generate diff_Deathdate5 = overlijdensdatum - BeginLRTIDBC5
...
*generate CLRTI_Death5 = 1 if diff_Deathdate5 < 14 & diff_Deathdate5 >=0
recode CLRTI_Death1 (.=0)
recode CLRTI_Death2 (.=0)
*recode CLRTI_Death3 (.=0)
*recode CLRTI_Death4 (.=0)
*recode CLRTI_Death5 (.=0)
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\InclusionDeath2015.dta", replace 

*merging LRTI_SEH_BEELD with hospitaladmissions 
use "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\LRTI_SEH_Beeld2015.dta", clear
sort rinpersoon rinpersoons
merge 1:1 rinpersoon rinpersoons using "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\HospitalAdmissions2015_all.dta"
drop if _merge==2
drop _merge
sort rinpersoon rinpersoons 
* creating new variables to determine if SEH, imaging and admission were within 14 days of each other 
foreach numrti of numlist 1/2 {
	foreach numopn of numlist 1/39 {
...
sort rinpersoon rinpersoons
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\InclusionsHospital2015.dta", replace
...
keep if CLRTI_adm1 == 1 | CLRTI_adm2 == 1 | CLRTI_Death1 == 1 | CLRTI_Death2 == 1 
...
*gen diff_Hospitalisation3 = BeginLRTIDBC4 - BeginLRTIDBC3
...
*gen diff_Hospitalisation4 = BeginLRTIDBC5 - BeginLRTIDBC4
*replace BeginLRTIDBC5 =. if diff_Hospitalisation4 < 14
*replace EindLRTIDBC5 =. if diff_Hospitalisation4 < 14
*replace date_LRTI_SEH_Beeld5 =. if diff_Hospitalisation4 < 14
*replace CLRTI_adm5 =. if diff_Hospitalisation4 < 14
save "H:\Datavoorbereiding\Ernst van Dokkum\Datasets 2015\CLRTI2015.dta", replace
